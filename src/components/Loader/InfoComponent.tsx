      ...
      <div className="max-w-7xl mx-auto px-5 py-20">
        ...
        <div className="text-center mb-20">
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 tracking-tight">
            Why Choose{" "}
            <span className="text-green-500 font-bold">linkly.io</span>?
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 transition-all duration-300 hover:transform hover:-translate-y-2 hover:border-green-500/30 hover:bg-white/8 overflow-hidden"
            >
              ...
              <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl flex items-center justify-center text-2xl mb-6 mx-auto">
                {feature.icon}
              </div>
        ...
        {/* Stats Section */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 mb-20 bg-white/3 backdrop-blur-sm border border-white/10 rounded-3xl p-12">
